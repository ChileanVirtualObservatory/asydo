...
model=IMCM(log,'33SO2',300,('Normal',100,70,0),('Normal',100,3),('Linear',math.pi/9,500.0))
model2=IMCM(log,'33SO2',300,('Normal',100,70,math.pi/9),('Normal',100,3),('Linear',math.pi/4,500.0))
