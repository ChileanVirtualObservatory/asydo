...
from asydopy import factory, vu, db
import astropy
...
ldb=db.lineDB(dbpath)
ldb.connect()
m_list=ldb.getMoleculeList(vu.freq_correct(f_pos-bw/2,-rvel),vu.freq_correct(f_pos+bw/2,-rvel))
ldb.disconnect()
print m_list
print len(m_list)
